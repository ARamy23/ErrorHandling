...
extension Date {
  ...
  ///   - generator: The random number generator to use when creating the new random date.
  /// - Returns: A random date within the bounds of `range`.
  public static func random<T>(in range: ClosedRange<Date>, using generator: inout T) -> Date
...
extension DatePresenter {
  public func present(usingString date: String) -> DateStringInput {
    DateStringInput(date: date)
  }

  public func present(usingDate date: Date) -> DateStringOutput {
...
extension SelfAdaptingDateFormatterBuilderProtocol {
  @discardableResult
  public func using(format: String) -> Self {
    formatter.dateFormat = format
    return self
  }

  public func using(format: Date.Format) -> Self {
    formatter.dateFormat = format.rawValue
    return self
  }

  @discardableResult
  public func using(localizedTemplate: String) -> Self {
    formatter.setLocalizedDateFormatFromTemplate(localizedTemplate)
    return self
  }

  @discardableResult
  public func using(localizedTemplate: [Date.Components]) -> Self {
    using(localizedTemplate: localizedTemplate.map(\.rawValue).joined(separator: ""))
  }
  ...
  @discardableResult
  public func adoptLocaleCalendar() -> Self {
    formatter.calendar = formatter.locale.calendar
    return self
  }

  @discardableResult
  public func adoptLocaleTimeZone() -> Self {
