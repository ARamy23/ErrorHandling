...
extension SizeRangeAdaptable {
  public var maxVBreakpoint: DeviceHeight {
    .iPadMini
  }

  public var minVBreakpoint: DeviceHeight {
    .iPhoneSE
  }

  public var maxHBreakPoint: DeviceWidth {
    .large
  }

  public var minHBreakPoint: DeviceWidth {
    .small
  }
  ...
  public func adaptV(min: AdaptableType, max: AdaptableType) -> AdaptableType {
  ...
  public func adaptV(min: AdaptableType) -> AdaptableType {
    let height = UIScreen.main.bounds.height
    let isTooSmall = height <= minVBreakpoint.height
  ...
  public func adaptV(max: AdaptableType) -> AdaptableType {
    let height = UIScreen.main.bounds.height
    let isTooBig = height >= maxVBreakpoint.height
  ...
  public func adaptH(min: AdaptableType, max: AdaptableType) -> AdaptableType {
    let height = UIScreen.main.bounds.height
  ...
  public func adaptH(min: AdaptableType) -> AdaptableType {
    let height = UIScreen.main.bounds.height
    let isTooSmall = height < minHBreakPoint.width
  ...
  public func adaptH(max: AdaptableType) -> AdaptableType {
