...
public class ShopCustomFontAppearance: DSDesignable {
  ...
  public init(brandColor: UIColor? = nil) {
    ...
    // Text
    let text = DSDesignableTextColor(
      largeTitle: DSColor.color(light: 0x14171a, dark: 0xfefffe),
    ...
    let primaryViewTextField = DSDesignableTextFieldColor(
      border: DSColor.color(light: 0xf3f4f2, dark: 0x101a24),
    ...
    let button = DSDesignableButtonColor(
      background: DSColor.color(light: 0x1da1f2, dark: 0x1da1f2),
    ...
    // Text
    let secondaryText = DSDesignableTextColor(
      largeTitle: DSColor.color(light: 0x14171a, dark: 0xfefffe),
      title1: DSColor.color(light: 0x14171a, dark: 0xfefffe),
      title2: DSColor.color(light: 0x14171a, dark: 0xfefffe),
      title3: DSColor.color(light: 0x14171a, dark: 0xfefffe),
    ...
    let secondaryViewTextField = DSDesignableTextFieldColor(
      border: DSColor.color(light: 0xfefffe, dark: 0x15202b),
      background: DSColor.color(light: 0xfefffe, dark: 0x15202b),
      text: text.headline,
      placeHolder: text.subheadline)

    // Button
    let sButton = DSDesignableButtonColor(
      background: DSColor.color(light: 0x5b7083, dark: 0x8899a6),
      title: DSColor.color(light: 0xfefffe, dark: 0xfefffe))
